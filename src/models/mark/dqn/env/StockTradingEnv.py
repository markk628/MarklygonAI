...
# from src.models.mark.dqn.utils.StateScaler import RollingMinMaxScaler
...
#         lose_rate = self.loss_making_trades / self.total_trades if self.total_trades > 0 else 0
...
class StockTradingEnv:
    ...
    def __init__(
        ...
        self.state_scaler = AdaptiveStateScaler()
    ...
    def _get_state(self) -> NDArray:
        ...
        if self.use_hierarchical:
            raw_states = {
                ...
                'is_out_of_game': float(self._is_out_of_game()),
    ...
    def get_branch_sizes(self):
        ...
        return {
            'stock_data_window_size': self.window_size,
            'stock_data_feature_size': self.feature_processor.feature_processor.n_components,
            'portfolio_metrics_size': 33,
            'market_state_metrics_size': 14,
            'constraint_metrics_size': 11,
            'action_size': 3
        }